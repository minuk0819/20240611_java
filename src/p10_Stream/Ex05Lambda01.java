...
public class Ex05Lambda01 {
  public static void main(String[] args) {
    ...
    // 2) 매개변수가 1개일 때만 ()는 생략 가능, 2개이상일 때 생략 불가.
    mi = (num) -> {};
    mi = num -> {};
    MyInterface2 min2 = (n1,n2) -> {};

    // 3) 매개변수가 있고, return type이 있는 경우
    MyInterface3 min3 = (n1, n2) -> {return n1+n2;};
    min3 = (n1,n2) -> n1+n2; // 중괄호를 생략하면 return도 생략.
