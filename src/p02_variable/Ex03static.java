...
public class Ex03static {
  ...
  // static : 공통된 값,  instance : 각각의 값
  public static void main(String[] args) {
    Ex03static e1 = new Ex03static();
    Ex03static e2 = new Ex03static();
    e1.vi = 10; System.out.println(e1.vi);
    e2.vi = 10; System.out.println(e2.vi);
    e1.vs = 200; System.out.println(e1.vs);
    e2.vs = 200; System.out.println(e2.vs);
  }
